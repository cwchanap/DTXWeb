...
export type GenerateMagicLinkMutation = {
	generateMagicLink: { magicLinkUrl: string; success: boolean };
};

export type SimfileFullFragment = {
	id: string;
...
export type SimfileWithFilesFragment = {
	...
	definitions: [
		{
			...
			name: { kind: 'Name', value: 'SimfileFull' },
			typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'Simfile' } },
			selectionSet: {
				kind: 'SelectionSet',
				selections: [
					...
					{ kind: 'Field', name: { kind: 'Name', value: 'videoPreviewUrl' } },
					{ kind: 'Field', name: { kind: 'Name', value: 'publishDate' } },
					{ kind: 'Field', name: { kind: 'Name', value: 'createdAt' } },
					{ kind: 'Field', name: { kind: 'Name', value: 'updatedAt' } },
					{
						kind: 'Field',
						name: { kind: 'Name', value: 'dtxFiles' },
						selectionSet: {
							kind: 'SelectionSet',
							selections: [
...
} as unknown as DocumentNode<SimfileFullFragment, unknown>;
export const SimfileWithFilesFragmentDoc = {
	kind: 'Document',
	definitions: [
		{
			kind: 'FragmentDefinition',
			name: { kind: 'Name', value: 'SimfileWithFiles' },
			typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'Simfile' } },
			selectionSet: {
				kind: 'SelectionSet',
				selections: [
					{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'SimfileFull' } },
					{
						kind: 'Field',
					...
					{ kind: 'Field', name: { kind: 'Name', value: 'hasUploadedFiles' } }
				]
			}
		},
		{
...
} as unknown as DocumentNode<SimfileWithFilesFragment, unknown>;
export const GenerateMagicLinkDocument = {
	kind: 'Document',
	definitions: [
		{
				...
				selections: [
					{
						...
						selectionSet: {
							kind: 'SelectionSet',
							selections: [
								{ kind: 'Field', name: { kind: 'Name', value: 'magicLinkUrl' } },
...
} as unknown as DocumentNode<GenerateMagicLinkMutation, GenerateMagicLinkMutationVariables>;
export const ListSimfilesDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'ListSimfiles' },
			variableDefinitions: [
				{
					...
					type: {
						kind: 'NonNullType',
						type: { kind: 'NamedType', name: { kind: 'Name', value: 'SimfileScope' } }
					}
				},
				{
					kind: 'VariableDefinition',
								...
								{ kind: 'Field', name: { kind: 'Name', value: 'count' } },
								{
									...
									selectionSet: {
										...
										selections: [
											...
											{
												kind: 'Field',
												name: { kind: 'Name', value: 'hasUploadedFiles' }
											}
										]
									}
								}
...
} as unknown as DocumentNode<ListSimfilesQuery, ListSimfilesQueryVariables>;
export const GetSimfileDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'GetSimfile' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
...
} as unknown as DocumentNode<GetSimfileQuery, GetSimfileQueryVariables>;
export const UpdateSimfileDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'mutation',
			name: { kind: 'Name', value: 'UpdateSimfile' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
				...
				},
				{
					...
					type: {
						...
						type: {
							kind: 'NamedType',
							name: { kind: 'Name', value: 'UpdateSimfileInput' }
						}
					}
				}
			],
...
} as unknown as DocumentNode<UpdateSimfileMutation, UpdateSimfileMutationVariables>;
export const DeleteSimfileDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'mutation',
			name: { kind: 'Name', value: 'DeleteSimfile' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<DeleteSimfileMutation, DeleteSimfileMutationVariables>;
			...
			variableDefinitions: [
				{
					...
					type: {
						...
						type: {
							kind: 'NamedType',
							name: { kind: 'Name', value: 'UpsertUserProfileInput' }
						}
					}
				}
			],
...
} as unknown as DocumentNode<UpsertUserProfileMutation, UpsertUserProfileMutationVariables>;
