/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 31b1885f3a48f2945fbf5b3dfb588db9)
// Runtime types generated with workerd@1.20260811.1 2025-01-01 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	ASSETS: Fetcher;
	PUBLIC_DTX_API_URL: 'https://api.pre-prod.dtx.hapadona.com' | 'https://api.dtx.hapadona.com';
	PUBLIC_ENABLE_BLOG_DOWNLOAD: 'false';
	API:
		| Fetcher /* dtx-api-pre-prod */
		| Fetcher /* dtx-api-pre-prod-prod-data */
		| Fetcher /* dtx-api */;
}
declare namespace Cloudflare {
	interface PreProdEnv {
		...
		PUBLIC_ENABLE_BLOG_DOWNLOAD: 'false';
		API: Fetcher /* dtx-api-pre-prod */;
	}
	interface PreProdProdDataEnv {
		ASSETS: Fetcher;
		PUBLIC_DTX_API_URL: 'https://api.pre-prod.dtx.hapadona.com';
		PUBLIC_ENABLE_BLOG_DOWNLOAD: 'false';
		API: Fetcher /* dtx-api-pre-prod-prod-data */;
	}
